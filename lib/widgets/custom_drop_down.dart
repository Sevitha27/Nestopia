...
class CustomDropDown extends StatelessWidget {
  ...
  Widget get dropDownWidget => SizedBox(
        ...
        child: DropdownButtonFormField(
          ...
          icon: icon,
          autofocus: autofocus!,
          style: textStyle ?? CustomTextStyles.titleMediumBluegray700,
          items: items?.map<DropdownMenuItem<String>>((String value) {
            return DropdownMenuItem<String>(
              ...
              child: Text(
                ...
                style: hintStyle ?? CustomTextStyles.titleMediumBluegray700,
              ),
            );
          }).toList(),
  ...
  InputDecoration get decoration => InputDecoration(
        hintText: hintText ?? "",
        hintStyle: hintStyle ?? CustomTextStyles.titleMediumBluegray700,
        prefixIcon: prefix,
