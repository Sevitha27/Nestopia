...
class MetropolitanmanorItemWidget extends StatelessWidget {
  const MetropolitanmanorItemWidget({Key? key})
      : super(
          key: key,
        );
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(
                  width: 173.h,
                  child: Text(
                    "City view  |  3rd floor  |  Elevator | Parking  | 1 person",
                    maxLines: 2,
